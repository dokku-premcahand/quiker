<div class="col-lg-offset-2 col-lg-8">
	...
	?>
	<div class="col-lg-12 center"><h3 class="MT0">Add Agent</h3></div>
	<form class="col-lg-offset-2 col-lg-8" action="<?php echo base_url('admin/addAgent')?>" method="POST" autocomplete="off">
