<div class="col-lg-offset-2 col-lg-8">
	...
	<div class="col-lg-12 center">
		<div class="col-lg-12">
			<form class="form-horizontal" action="<?php echo base_url("admin/searchProduct"); ?>" method="POST" id="searchForm">
		...
		<div class="col-lg-12">
			<form class="form-horizontal" action="<?php echo base_url("admin/exportAll"); ?>" method="POST">
				<div class="form-group">
